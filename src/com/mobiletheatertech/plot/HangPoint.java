...
/**
 * <p>
 * Hard hang point built into the ceiling of the venue.
 * </p><p>
 * XML tag is 'hangpoint'.
 * There are no children.
 * Required attributes are 'x' and 'y', which define its location relative to
 * the venue.
 * The z-coordinate is derived from the height of the venue.
 * Optional attribute is 'id', which becomes necessary if a hangpoint
 * is to be referenced.
 * </p>
 *
 * @author dhs
...
public class HangPoint extends Minder {
     ...
     * @throws LocationException if some coordinate is outside the area of the {@link Venue}.
     */
