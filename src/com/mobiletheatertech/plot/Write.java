...
/**
 * <code>Write</code> deals with output file issues and relies on {@link Draw Draw} to generate SVG content.
 *
 * @author dhs
 * @since 0.0.1
 */
public class Write {
     ...
     * <p/>
     * The complete pathname is built as {@literal <user's home directory>}{@code /Plot/out/}{@literal <basename>}{@code
     * .xml}
     * <p/>
     * The non-drawing updates to the generated SVG document have to be done after all of the drawing is completed.
     * Because of this, {@code Write} needs to interact with {@link Draw} and {@link Minder} methods in a very specific
     * order.
     *
