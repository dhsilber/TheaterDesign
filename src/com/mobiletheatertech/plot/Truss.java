...
/**
 * Defines a box truss. <p> XML tag is 'truss'. Required children are 'suspend' elements. Required attributes are 'size'
 * (valid values are 12 and 20) and 'length'. </p><p> For now, I'm allowing any length of truss, so that assemblies
 * </p>
 *
 * @author dhs
 * @since 0.0.5
