 ...
 * 
 * All plot item classes need to implement a static method {@code ParseXML} to
 * parse an XML description of the item.
 *
 * @author dhs
 * @since 0.0.2
 */
public abstract class Minder {
    ...
    /**
     * Give each of the plot items an opportunity to modify the document after
     * the drawing is done.
     *
    ...
    /**
     * Acquire the named attribute from the {@link org.w3c.dom.Element Element}
     * and convert it to an {@code Integer}.
     * 
    ...
    /**
     * Acquire the named attribute from the {@link org.w3c.dom.Element Element}
     * and convert it to a {@code String}.
     * 
     * @param element DOM Element defining a venue.
     * @param name name of attribute.
     * @return Integer value of attribute
    ...
    /**
     * This is called for each Plot item to give it a chance to update the DOM
     * for the generated SVG. Items that make use of this functionality will
     * replace this comment with specifics.
     * 
     * @param draw 
     */
