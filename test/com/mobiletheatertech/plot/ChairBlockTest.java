...
//    private static final Integer ZERO = 0;
    ...
    public void storesAttributesLocation() throws Exception {
        ...
        assertEquals(TestHelpers.accessDouble(chairBlock, "x"), X.doubleValue());
        assertEquals(TestHelpers.accessDouble(chairBlock, "y"), Y.doubleValue());
        assertEquals(TestHelpers.accessDouble(chairBlock, "width"), WIDTH.doubleValue());
        assertEquals(TestHelpers.accessDouble(chairBlock, "depth"), DEPTH.doubleValue());
    ...
    public void storesAttributesPerimeter() throws Exception {
        ...
        assertEquals(TestHelpers.accessDouble(chairBlock, "x"), DOUBLEZERO );
        assertEquals(TestHelpers.accessDouble(chairBlock, "y"), DOUBLEZERO );
        assertEquals(TestHelpers.accessDouble(chairBlock, "width"), DOUBLEZERO);
        assertEquals(TestHelpers.accessDouble(chairBlock, "depth"), DOUBLEZERO);
    ...
    public void registersLayer() throws Exception {
        ...
        assertFalse(layers.containsKey(ChairBlock.LAYERTAG));

        ChairBlock chairBlock = new ChairBlock(element);

        layers = Layer.List();
        assertTrue(layers.containsKey(ChairBlock.LAYERTAG));
        assertEquals( layers.get( ChairBlock.LAYERTAG ).name(), ChairBlock.LAYERNAME );
    }
    ...
    private void domCheckSymbolGeneration() throws Exception {
        ...
        /* 0th elementOnPipe is the empty defs tag generated by Batik - why? */
...
//        assertEquals( createdGroups.getLength(), 2 );
        ...
        String expectedX = Double.toString(X + CHAIRWIDTH / 2 + 2);
