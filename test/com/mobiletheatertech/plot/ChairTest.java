...
private    String layerTag = "fred";
    ...
    public void storesAttributes() throws Exception {
        ...
        assertEquals(TestHelpers.accessDouble(chair, "space"), (Double)0.0);
        assertEquals(TestHelpers.accessDouble(chair, "orientation"), (Double)0.0 );
...
//        assertEquals(TestHelpers.accessDouble(chair, "angle"), (CHAIRWIDTH * 10) / (2 * Math.PI) );
    ...
    public void verifyCountCircle() throws Exception {
        ...
        Chair chair = new Chair( element );
        chair.verify();
        assertEquals(TestHelpers.accessDouble(chair, "radius"), (Double)((CHAIRWIDTH * 10.0) / (2.0 * Math.PI)) );
        assertEquals(TestHelpers.accessInteger(chair, "chairFit"), (Integer) 10 );
        assertEquals(TestHelpers.accessDouble(chair, "angle"), (Double)36.0 );
        assertEquals(TestHelpers.accessDouble(chair, "circumference"), (Double)(CHAIRWIDTH * 10.0) );
    }
    ...
    public void verifyCountOpeningCircle() throws Exception {
        ...
        assertEquals(TestHelpers.accessDouble(chair, "circumference"), (Double)(CHAIRWIDTH * 4.0) );
        assertEquals(TestHelpers.accessDouble(chair, "angle"), (Double)90.0 );
        assertEquals(TestHelpers.accessDouble(chair, "radius"), (Double)((CHAIRWIDTH * 4) / (2 * Math.PI)) );
    }
    ...
    public void domLegendItemContent() throws Exception {
        ...
        assertEquals( thisX, (Double)(Chair.CHAIRWIDTH  / 2.0) );
        Double thisY = new Double( element.getAttribute("y") );
        assertEquals( thisY, (Double)(Chair.CHAIRDEPTH / 2.0) );
...
//        http://gamedev.stackexchange.com/questions/18340/get-position-of-point-on-circumference-of-circle-given-an-angle
        ...
        assertEquals(element.getAttribute("xlink:href"), "#chair");
        Double thisX = new Double( element.getAttribute("x") );
        assertEquals( thisX, (Double)0.0 );
        Double thisY = new Double( element.getAttribute("y") );
        assertEquals( thisY, (Double)0.0 );
