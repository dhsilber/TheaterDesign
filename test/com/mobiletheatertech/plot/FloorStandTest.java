...
//        FloorStand floorStand = new FloorStand( baseElement );
//
...
//
//        baseElement = new IIOMetadataNode( "floorStand" );
//        baseElement.setAttribute( "x", "12" );
//        baseElement.setAttribute( "y", "32" );
//        baseElement.setAttribute( "width", width.toString() );
//        baseElement.setAttribute( "depth", depth.toString() );
//
//        Element luminaire1 = new IIOMetadataNode( "luminaire" );
//        luminaire1.setAttribute( "size", "12" );
//        luminaire1.setAttribute( "length", "320" );
//        luminaire1.appendChild( baseElement );
